...
const Manager = () => {
  ...
  const savePassword = async () => {
    ...
    if (
      ...
      await fetch("http://localhost:3000/", {method: "POST", headers: {"Content-type": "application.json"}, body: JSON.stringify({id: form.id})} )
  ...
  const deletePassword = async (id) => {
    ...
    if (Confirm) {
      ...
      // );
      let res = await fetch("http://localhost:3000/", {method: "POST", headers: {"Content-type": "application.json"}, body: JSON.stringify({id})} )
